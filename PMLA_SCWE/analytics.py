"""Analytics engine and statistical predictive models."""
...
def get_student_analytics_summary(student_id: int) -> dict[str, Any] | None:
    ...
    # 8. Risk Level
    # HIGH if health < 50 OR attendance < 75 OR (academic < 50 AND declining trend)
    if health_score < 50.0 or attendance_percentage < 75.0 or (academic_average < 50.0 and pred["trend_direction"] == "Declining"):
        risk_level = "HIGH"
    # MEDIUM if health < 70 OR attendance < 85 OR wellness < 60 OR declining trend
